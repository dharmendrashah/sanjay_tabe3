...
export default class Videos extends Component{
    constructor(props) {
      ...
      MoveToNewsDetails = (id) => {
        return this.props.navigation.navigate('VideoDetail', {selectedNews: id});
    }
    ...
    MoveToNewsCategoryList = (id) => {
      ...
      Swipe = () => {
        ...
        return(
          <View style={{height: displayHeight/3, borderRadius: 20, shadowColor: '#000', elevation: 10}}>
          <ScrollView
          horizontal={true}
...

          {
            Videos.map((v, k) => {
              ...
              return (
                ...
                <View style={{flex:1, borderRadius: 20, zIndex: 999999, flexDirection:'row', height: 300, width: displayWidth-50}}>
    ...
    Allcate = () => {
      ...
      return(
...

        {
          VideoCategory.map(e => {
            return(
              <TouchableOpacity style={{ width: '15%', marginEnd: 20, shadowColor: '#000', elevation: 10 }} onPress={() => this.MoveToNewsCategoryList(e.id)}>
              <View style={{ backgroundColor: 'white', width: '100%', borderRadius: 20, marginEnd: '2%', shadowColor: '#000', elevation: 20 }}>
                  <Image 
      ...
      return(
        <View style={styles.Allcate}>
         ...
         <Text style={{ color: 'white', fontSize: 20 }}>
          ...
          >
          <View style={{ backgroundColor: 'white', height: 100, borderRadius: 10, flexDirection: 'row', marginBottom: 10 }}>
            
            <Text style={{ marginStart: '5%', marginTop: '5%', color: 'black', fontSize: 15, width: '70%' }}>
             {this.title(e.title)}
             {'\n'}
             <Text style={{ color: '#bfbbbb', paddingTop: 10}}>
               {this.description(e.details)}...
             </Text>
           </Text>
            <Text style={{ marginTop: 2, height: 30, borderRadius: 5, color: 'white', position: 'absolute', zIndex: 99999, backgroundColor: 'grey', marginStart: 220, width: -10, padding:5 }}>30 Jul</Text>
            <View style={{marginStart: 13}}>
            <Image 
            source={{ uri: LINK+'uploads/'+e.image }}
            style={{ width: 80, height: 100, borderTopRightRadius:10, borderBottomRightRadius:10}}
            />
            </View>
            </View>
            </TouchableOpacity>
