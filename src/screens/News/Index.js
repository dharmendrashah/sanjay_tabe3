      ...
      <ScrollView horizontal contentContainerStyle={{width: 1000}}>
{
            categories.map((e) => {
              return (
                <TouchableOpacity style={{ width: '15%', marginEnd: 20 }} onPress={() => this.MoveToNewsCategoryList(e.id)}>
         ...
         <Text style={{ color: 'white', fontSize: 20 }}>
...

          {
            news.map(e => {
              ...
              <Text style={{ marginTop: 2,borderRadius: 5, color: 'white', position: 'absolute', zIndex: 99999, backgroundColor: 'grey', marginStart: 190, width: -20 }}>{e.month}</Text>
