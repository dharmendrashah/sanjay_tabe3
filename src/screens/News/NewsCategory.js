              ...
              resultObject.map(e => {
                return(
                  ...
                  <View style={{ backgroundColor: 'white', height: 100, borderRadius: 10, flexDirection: 'row', marginBottom: 10 }}>
                    ...
                    <Text style={{ marginTop: 2,borderRadius: 5, color: 'white', position: 'absolute', zIndex: 99999, backgroundColor: 'orange', marginStart: 190, width: -20 }}>30 Jul</Text>
                    <Image 
                    source={{ uri: LINK+'uploads/'+e.image }}
                    style={{backgroundColor: 'white', width: '100%', borderRadius: 5, height: '100%'}}
                    />
                    </View>
                    </TouchableOpacity>
                );
